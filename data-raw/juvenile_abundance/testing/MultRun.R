...
for(isite in 1:Nsites){
  ...
  #for(iyr in 7:7){
    ...
    abundance<-bugs(data, inits, parameters, "abundance_model.bug", debug=F,n.chains=Nchains, n.burnin=Nburnin,n.thin=Nthin,n.iter=Nmcmc,codaPkg=F,DIC=T,clearWD=T,bugs.directory="c:/WinBUGS14/")	#run bugs model
