...
saveRDS(lcc_2015, file = here::here("data-raw", "juvenile_abundance",
                                    "split_lcc_results", "lcc_2015.rds"))


cc_results <- purrr::pmap(list(trials_to_fit$site,
...
test <- run_split_models("lcc", 2018)
