...
container_name = "model_fits"
model_pin_board(storage_account, container_name)
model_fits <- readRDS("data/ubc_2004_2024-07-23.rds")
store_model_fit(con,
                storage_account = "geneticsedidata",
                )
# insert_model_name(model_fits, con)
# insert_model_run(con, model_fits, "www.azure.com/5", "model fit ID yuh")
