...
mcmc_trace(battle_results$full_object, pars = c("b1_survival", "mean_redds_per_spawner"))
mcmc_areas(battle_results$full_object, pars = c("b1_survival", "mean_redds_per_spawner"))

mcmc_rhat(rhat(battle_results$full_object))
