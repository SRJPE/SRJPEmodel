...
```
Ultimately, this variable could not be used for Mill Creek or Clear Creek, but as more data become available it should be incorporated as a potentially important variable.
...
Yuba River provided adult spawner abundance as estimated by CJS. These data, however, are only available for four years: 2014, 2015, 2019, and 2020. 

Feather River has not yet provided adult spawner abundance as estimated by CJS. Raw carcass counts are available but a JPE-specific CJS model has not yet been developed.
