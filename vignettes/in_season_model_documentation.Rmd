...
inseason_inputs <- prepare_inseason_inputs(con, "clear creek", "lcc",
                                             covariate_effect = FALSE,
                                             autocorrelation = FALSE)
inseason_fit <-  get_most_recent_model_objects(con, 
                                        ...
                                        model_name = "inseason", 
                                        stream = "clear creek")
inseason_fit_subset <- inseason_fit$`1024_inseason_lcc_clear creek_NA`
```
...
inseason_estimates <- extract_inseason_estimates(inseason_inputs, inseason_fit_subset)
```
