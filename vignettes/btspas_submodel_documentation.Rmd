...
inputs <- get_most_recent_model_objects(con, 
                                        ...
                                        stream = "battle creek") 
fits <- get_most_recent_model_objects(con, 
                                        model_component = "model_fit", 
                                        model_name = "bt_spas_x", 
                                        stream = "battle creek") 
inputs_2018 <- inputs$`567_bt_spas_x_ubc_battle creek_2018`
fits_2018 <- fits$`567_bt_spas_x_ubc_battle creek_2018`

generate_diagnostic_plot_juv(site_arg = "ubc", run_year_arg = 2018, abundance_model_fit_table = fits_2018)
plot_juv_data("ubc", 2018)
```
