...
knitr::include_graphics(path = here::here("vignettes", "images", "SRJPE Conceptual Model - 2-15-2024.png"),
                        rel_path = FALSE)
```
...
```{r, echo = FALSE, out.width = "500px"}
knitr::include_graphics(path = here::here("vignettes", "images", "parameter_diagram.png"),
                        rel_path = FALSE)
```
